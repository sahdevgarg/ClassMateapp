 ...
 */
public class ReportCardRecyclerViewAdapter extends RecyclerView.Adapter<ReportCardRecyclerViewAdapter.ViewHolder> {
    ...
    public ReportCardRecyclerViewAdapter(Context context, OnRecyclerItemClick onRecyclerItemClick, ArrayList<AttendancePojo.Result> attendanceArrayList)
    {
...
//                .build();
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.reportcard_group_item, parent, false);
