 ...
 */
public class KYC_Mother_Info extends Fragment {
    private Communication communication;
    private Button mNextButton;

    public KYC_Mother_Info(Communication communication) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.kyc_mothers_info_fragment,container,false);
    }
