 ...
 */
public class KYC_Father_Info extends Fragment {
    private Communication communication;
    private Button mNextButton;

    public KYC_Father_Info(Communication communication) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.kyc_fathers_info_fragment,container,false);
    }
